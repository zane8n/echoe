...
export default function Home() {
    ...
    return (
        <main className="home-view relative z-10 mx-auto w-[min(100%,760px)]">
            <PathCarousel events={state.events} profile={state.settings.profile} sharedByMe={social.sharedByMe} sharedWithMe={social.sharedWithMe} onHabitCheckIn={(id) => handleHabitCheckIn(id)} onProjectCheckIn={handleProjectCheckIn} onOpenHistory={setCheckInEventId} onProgress={setProgressEventId} onCheer={(shareId) => void cheerShare(shareId)} />
